...
//|        Donchian breakout – kiegyensúlyozott H4, lazább szűrés    |
//+------------------------------------------------------------------+
#property strict
...
//==================================================================
// STRATÉGIA BEÁLLÍTÁSOK – V3-B (kiegyensúlyozott, stabil)
//==================================================================

input ENUM_TIMEFRAMES InpTimeframe      = PERIOD_H4;   // H4 idősík
input int             InpDonchianPeriod = 14;          // 12–16 középérték
input bool            InpAllowLong      = true;
input bool            InpAllowShort     = true;

//==================================================================
// TREND SZŰRŐ (enyhén lazítva)
//==================================================================
...
//==================================================================
// VOLATILITÁS & KITÖRÉS MINŐSÉG (ATR – enyhén lazítva)
//==================================================================

input int    InpATRPeriod            = 14;
input double InpMinATRMultiplier     = 0.4;   // kicsit lazább, mint 0.5
input double InpMinBreakoutRangeATR  = 0.8;   // nem kell teljes 1.0 ATR
...
input double InpTakeProfit_R  = 2.50;   // kicsit konzervatívabb, stabilabb
...
void CheckForEntry()
{
   ...
   // Donchian channel (előző gyertyák, aktuálisat kerüljük)
   ...
   if(InpUseTrendFilter)
   {
      ...
      // Lazább feltétel: nem kell tökéletes “lépcső”, elég ha fast > mid és mid > slow
      longTrendAllowed =
         (signalClose > midEMA) &&   // nem kell feltétlen fast fölé zárni
         (fastEMA > midEMA) &&
         (midEMA > slowEMA);
   ...
   // Kitörő gyertya minősége ATR-hez képest (lazább)
   double breakoutRange = rates[1].high - rates[1].low;
   ...
   // Átlagos range vs ATR (dead market szűrés – lazább)
   double avgRange = 0.0;
