...
input int InpDonchianPeriod = 18;
...
input bool InpUseMarketStructure = false;
...
input bool InpUseMFEExit = false;
...
void CheckForEntry() {
  ...
  bool longSignal =
      InpAllowLong && close > high + atr * InpBreakoutBufferATR && longOK;

  bool shortSignal =
      InpAllowShort && close < low - atr * InpBreakoutBufferATR && shortOK;
