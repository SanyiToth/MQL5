//+------------------------------------------------------------------+
//|                        DonchianBreakoutEA_v3C.mq5                |
//|   Donchian breakout H4 – lazított szűrés + drawdown védelem      |
//+------------------------------------------------------------------+
#property strict
...
//+------------------------------------------------------------------+
// TRADE TRANSACTION HANDLER (MQL5-COMPATIBLE)
//+------------------------------------------------------------------+
                        ...
                        const MqlTradeResult       &res)
{
   ...
   // Only closed deals (SL, TP, manual close)
...
void CheckForEntry()
{
   ...
   if(InpUseTrendFilter)
   {
      ...
      longOK  = (f > m && m > s && close > m);
      shortOK = (f < m && m < s && close < m);
   }
